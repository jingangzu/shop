...
<div class="theshopshow">
	<!--left-->
        ...
        <script src="js/lib.js"></script>
			<div id="preview">
				<div class=jqzoom id="spec-n1" onClick="window.open('/')"><IMG height="350" src="/img/img04.jpg" jqimg="img/img04.jpg" width="350">
					</div>
					<div id="spec-n5">
    ...
    <div class="shoppnum">
    	<!--n1-->
        <div class="shanpmai">
        	<h1 class="spdname">戴尔（DELL）Vostro 3800-R6198M 台式电脑 （赛扬G1840 4G 500G DVD 三年上门 三年硬盘保留）</h1>
            <div class="hotspeak">
