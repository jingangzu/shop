...
<div class="order_list" id="order_list">
  <div class="h_products_list clearfix" id="products_list">
	...
	<tbody>
     ...
     <a title="订单详细"  href="{{ url("/admin/order") }}/1"  class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a> 
     <a title="删除" href="javascript:shanchu(1);"   class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>  <!-- 
     ...
     <a title="订单详细"  href="{{ url("/admin/order") }}/2"  class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a> 
     <a title="删除" href="javascript:;"  onclick="Order_form_del(this,'1')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>    
     </td>
     </tr>
     <tr>
     ...
     <td>2</td>
      <td class="td-status"><span class="label label-success radius">代发货</span></td>
     <td>
     <a onClick="Delivery_stop(this,'10005')"  href="/admin/1/edit" title="发货"  class="btn btn-xs btn-success"><i class="fa fa-cubes bigger-120"></i></a> <!-- 
     ...
     <a title="订单详细"  href="{{ url("/admin/order") }}/3"  class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a> 
     <a title="删除" href="javascript:;"  onclick="Order_form_del(this,'1')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>    
     </td>
     </tr>
...
function shanchu(id)
{
    $("#form").attr('action',"{{ url('/admin/order') }}/"+id);
    $('#form').submit();
}
//左侧显示隐藏
$(function() { 
