		...
		<div class="login">
			<div class="login_center">
				...
				<div class="login_main center">
					<div class="username">账&nbsp;&nbsp;&nbsp;&nbsp;号:&nbsp;<input class="shurukuang" type="text" name="username" placeholder="用户名/手机号/邮箱"/></div>
					...
					<div class="username">
						...
						<div class="right fl"><img src="/index/image/yanzhengma.jpg"></div>
						<div class="clear"></div>
					</div>
				</div>
