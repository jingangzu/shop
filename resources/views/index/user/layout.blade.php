...
<meta charset="utf-8">
<title>我的购物车</title>
<link rel="stylesheet" type="text/css" href="/index/css/vipcenter.css">
...
<div class="thetoubu">
	...
	<div class="thetoubu1">
        ...
        <em>欢迎来到会员中心</em>
        <a href="#">地址管理</a>
        <a href="/index/user/redact">修改资料</a>
        <h5>账户安全</h5>
        <strong>低</strong>
        <span>
        	<p style=" width:27%"></p>
    ...
    <div class="xiangxilbnm">
        ...
        <div class="liefyu">
            ...
            <h2>资料管理</h2>
                <div class="conb">
                <a href="/index/user/account">账户信息</a>
                <a href="#">账户安全</a>
                <a href="{{ url('index/address/index') }}">收货地址</a>
                <a href="#">我的消息</a>
                <a href="#">我的好友</a>
                <a href="#">我的足迹</a>
                <a href="#">第三方账号登录</a>
